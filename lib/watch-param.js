...
module.exports = function (param, listener, continuous) {
  ...
  var releaseWatch = watch(param.currentValue || param, function (value) {
    ...
    if (ParamSource.isParam(value)) {
      watchParam(value, listener)
...
function watchParam (param, listener) {
  param.onEvent((event) => {
    if (event.value != null) {
...
function watchAudioNode (param, listener, continuous) {
  ...
  processor.onaudioprocess = function (e) {
    ...
    if ((value !== lastBroadcastValue && !(isNaN(value) && isNaN(lastBroadcastValue)) || continuous)) {
