...
function recordToDisk (audioContext, nodes, onStart, onTick) {
  ...
  recorder.onaudioprocess = function (e) {
    if (!started) {
      ...
      if (typeof onStart === 'function') {
        var latency = e.playbackTime - audioContext.currentTime
        onStart(audioContext.currentTime - latency - audioContext.baseLatency)
      }
    }
    var count = 0
    outputPaths.forEach((path, i) => {
