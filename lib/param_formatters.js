var beatValues = [1/16, 1/12, 1/8, 1/6, 1/4, 1/3, 2/3, 1, 2, 3, 4]
...
module.exports = {
  ...
  'sampleRatio': {
    ...
    display: function(value){
      return window.context.editor.get(':hz(unit)', value*48000)
    }
  },
  ...
  'beat': {
    ...
    display: function(value){
      return window.context.editor.get(':beat(unit)', value)
    }
  },
