...
module.exports = function (node, opts) {
  var resolvedNode = node.resolved || node
  ...
  var color = resolvedNode.color || QueryParam(node, 'color')
  ...
  return h('div ExternalNode', {
    ...
    h('header', {
      ...
      Editable(node.id, { enabled: selected, onChange: actions.updateChunkReferences }),
      opts.extraHeader,
