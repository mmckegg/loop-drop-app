...
function renameElement(fileName, saveRename, cancelRename){ 
  if (!(this instanceof renameElement)) return new renameElement(fileName, saveRename, cancelRename) 
...
renameElement.prototype.init = function(){
  ...
  element.textContent = getBaseName(this.fileName, '.json')
...
renameElement.prototype.getValue = function(){
  return this.element.textContent.trim() + '.json'
}
